    ...
    <Section id="contact" title="Get in Touch!" className="mb-[2rem]">
      ...
      >
        ...
        <div className="flex justify-between sm:justify-end items-center w-full">
          {/* Social links */}
          <div className="static sm:absolute sm:top-[50%] sm:translate-y-[-50%] lg:left-[10rem] left-[5rem] flex sm:flex-col gap-[1.5rem] xs:gap-[3rem] sm:gap-[6rem] items-center z-10">
            {/* Linked in link */}
            <a
          ...
          <button
            type="submit"
            className="p-[1rem] px-[2rem] border-purple-primary border text-purple-primary text-[2rem]  hover:border-white hover:text-white duration-200 rounded-[.5rem]"
          >
            Send Message
          </button>
        </div>
