...
function ShortlyCaseStudy() {
  const { project } = useSelector((state) => state.caseStudyReducer);
  const tools = useSelector((state) => state.toolsReducer);

  return (
    <ProjectCaseStudy visible={project?.name === "Shortly"}>
      {/* Title */}
      <h2 className="text-[4rem] flex items-center gap-[2rem] text-[#2ACFCF] font-bold ">
      ...
      {/* Live app link */}
      <h3 className="text-[2rem] text-[#2ACFCF] block">Live App link</h3>
      <a
      ...
      {/* Repository link */}
      <h3 className="text-[2rem] text-[#2ACFCF] block mt-[2rem]">
        Repository link
      </h3>
      <a
        href={project?.appRepositoryLink}
      ...
      <h3 className="text-[2rem] text-[#2ACFCF] mb-[1.5rem] mt-[6rem] block">
        Visual overview of the app
      </h3>
      <video
        src="https://res.cloudinary.com/dlanhtzbw/video/upload/v1678453349/Portfolio/Shortly/Shortly_Summary_y9xvvt.mp4"
      ...
      <ul className="list-disc list-inside space-y-[5rem] pt-[2rem]">
        {/* Link shortener */}
        <li className="">
          <h4 className="inline-block font-semibold">Link Shortener</h4>
          <div className="mt-[1rem]">
            This is the component that takes user inputted link and shortens it,
            this feature was achievable by connecting to an{" "}
            <span className="text-[#2ACFCF]">external API</span> that performs
            the action.
            <div className="grid grid-cols-2 gap-[2rem] grid-col- mt-[3rem] overflow-hidden md:grid-cols-1">
              <Image
                src="https://res.cloudinary.com/dlanhtzbw/image/upload/v1678455532/Portfolio/Shortly/Link_shortener_r5tkzf.png"
                alt=""
                className=""
        ...
        {/* Shortened Link */}
        <li className="">
          <h4 className="inline-block font-semibold">Shortened Link</h4>
          <div className="mt-[1rem]">
            This compnent shows the link the user has shortened and the result,
            there is also a copy button that allows user to copy link to
            clipboard. This was developed using{" "}
            <span className="text-[#2ACFCF]">React</span> to display all
            shortened links and{" "}
            <span className="text-[#2ACFCF]">Navigator Clipboard API</span> to
            copy link to clipboard
            <div className="grid grid-cols-2 gap-[2rem] grid-col- mt-[3rem] overflow-hidden md:grid-cols-1">
              <Image
                src="https://res.cloudinary.com/dlanhtzbw/image/upload/v1678455618/Portfolio/Shortly/Shortened_link_nenkop.png"
                alt=""
                className=""
                containerClassName="w-fit"
              />
      ...
      <h3 className="text-[2rem] text-[#2ACFCF] mt-[6rem] inline-block mb-[1rem]">
        Tech stacks
      </h3>
      <p className="">
...
export default ShortlyCaseStudy;
